...
void PIDcalculation(){
  desired = (((4 * 3.14) * analogRead(pos_in))/2046) - ((2 * 3.14) / 3);
  err = desired - encoder0Pos;
...
void setup() {
  ...
  attachInterrupt(0, doEncoder_Expanded, RISING);  // encoder pin on interrupt 0 - pin 2
  Serial.begin (9600);
